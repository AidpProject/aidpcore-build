 ...
 * <ul>
 * <li> `browser:uncompressed` - build uncomprssed browser bundle (`aidpcore-*.js`)
 * <li> `browser:compressed` - build compressed browser bundle (`aidpcore-*.min.js`)
...
function startGulp(name, opts) {
  ...
  var fullname = name ? 'aidpcore-' + name : 'aidpcore';
  var files = ['lib/**/*.js'];
  var tests = ['test/**/*.js'];
  var alljs = files.concat(tests);

  var buildPath = './node_modules/aidpcore-build/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external aidpcore-lib -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:aidpcore-lib -o aidpcore-lib.js';
    }
